...
type RecentPostQuery = { readonly allMdx: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<Mdx, 'id'>
        & { readonly frontmatter: Maybe<Pick<MdxFrontmatter, 'title' | 'tags' | 'date'>>, readonly fields: Maybe<Pick<MdxFields, 'slug'>> }
      ) }> } };
...
type TagPageQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, readonly allMdx: { readonly edges: ReadonlyArray<{ readonly node: { readonly fields: Maybe<Pick<MdxFields, 'slug'>>, readonly frontmatter: Maybe<Pick<MdxFrontmatter, 'date' | 'title'>> } }> } };
...
type IndexPageQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, readonly allMdx: { readonly edges: ReadonlyArray<{ readonly node: { readonly fields: Maybe<Pick<MdxFields, 'slug'>>, readonly frontmatter: Maybe<Pick<MdxFrontmatter, 'date' | 'title'>> } }> } };
